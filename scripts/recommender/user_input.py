...
from constants import available_activities, available_exercise_categories, available_facilities
...
def invoke_argparse():
    ...
    parser.add_argument("--preferred-days-hours", type=str, help="Enter the days and hours you prefer to go (semicolon separated) (day; hour range (min, max)), leave blank if you are not interested in any days or hours (example: \"m; 6, 11; t; 6, 11\" for Monday 6am - 11am and Tuesday 6am - 11am)", required=False, default="None")
    parser.add_argument("--unavailable-days-hours", type=str, help="Enter the days and hours you are unavailable (semicolon separated) (day; hour range (min, max)) (example: \"t; 10, 12; s; 9, 12\" for Tuesday 10am - 12pm and Saturday 9am - 12pm)", required=True, default="None")
